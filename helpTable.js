...
const helpTable = {
    ...
    'return': " -- return\n" +
        ...
        "\n" +
        "	See also: function.",
    'function': " -- function OUTPUTS = function_name (INPUT, ...)\n" +
    ...
    'root': "Compute the root of each element of X." +
        "If X is negative, a complex result is returned.",
    'pow': "",
    'logbl': "",
    'size': "-- SZ = size (A)\n" +
    ...
    'ind2sub': "-- [S1, S2, ..., SN] = ind2sub (DIMS, IND)\n" +
    ...
    'max': "",
    'mean': "",
    'horzcat': " -- horzcat (ARRAY1, ARRAY2, ..., ARRAYN)\n" +
    ...
    'vertcat': " -- vertcat (ARRAY1, ARRAY2, ..., ARRAYN)\n" +
...
const helpUsage = "	For help with individual commands and functions type\n" +
    "\n" +
    "		help NAME\n" +
    "\n" +
    ...
    "\n" +
    "		doc";
const helpOperatorMessage = "To obtain help on an operator, type\n\thelp \"NAME\"   or   help 'NAME'\n";
const helpFinalMessage = "\n\nAdditional help for built-in functions and operators is\n" +
...
const list_in_columns = function (list, nsep) {
    let longest_length = list.slice().sort(function (a, b) {
...
const removeQuotes = function (str) {
    ...
    if ((str.length >= 2) && (((firstchar === "\"") && (lastchar === "\"")) ||
        ((firstchar === "'") && (lastchar === "'")))) {
...
const helpCommand = function (args) {
    if (args.length == 0) {
        return helpUsage;
    }
...
const docCommand = function (args) {
    if (args.length == 0) {
        ...
        throw new Error("Invalid call to doc.  Correct usage is:\n" +
            "\n" +
            "-- doc FUNCTION_NAME\n" +
            "-- doc\n" +
            helpFinalMessage);
